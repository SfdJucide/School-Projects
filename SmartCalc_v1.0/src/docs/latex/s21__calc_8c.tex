\hypertarget{s21__calc_8c}{}\doxysection{Файл Smart\+Calc/s21\+\_\+calc.c}
\label{s21__calc_8c}\index{SmartCalc/s21\_calc.c@{SmartCalc/s21\_calc.c}}
...
\item 
int \mbox{\hyperlink{s21__calc_8c_a6bc0290fd7bb65ace779387602a2f91c}{calc}} (char $\ast$input, long double $\ast$result)
\begin{DoxyCompactList}\small\item\em Вычисление выражения \end{DoxyCompactList}\item 
void \mbox{\hyperlink{s21__calc_8c_a6667074b192216c2bf8a45ac5248cfc9}{get\+\_\+polish\+\_\+notation}} (char $\ast$$\ast$input, char $\ast$$\ast$result)
\begin{DoxyCompactList}\small\item\em Преобразование инфиксной записи в польскую нотацию \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s21__calc_8c_ab3b65ec8106201bd2ffe29d3d3e24d3f}{is\+\_\+digit}} (char symbol)
\begin{DoxyCompactList}\small\item\em Проверка является ли символ числом \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s21__calc_8c_a1af1a8119589bd1881acf16f56d8bf78}{priority}} (char sign)
\begin{DoxyCompactList}\small\item\em Вычисление приоритета операции \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s21__calc_8c_a426e7a37f18103788c2ff1fd0b034547}{validate\+\_\+input}} (char $\ast$input)
\begin{DoxyCompactList}\small\item\em Валидация входного выражения \end{DoxyCompactList}\item 
void \mbox{\hyperlink{s21__calc_8c_aa042b6eb8b60790ff8160a48d15f3507}{get\+\_\+lexems}} (char $\ast$input, char $\ast$$\ast$result)
\begin{DoxyCompactList}\small\item\em Преобработка входного выражения \end{DoxyCompactList}\item 
long double \mbox{\hyperlink{s21__calc_8c_ae346379100c9902e9d21514e33f70279}{calculate\+\_\+lexems}} (char $\ast$$\ast$input)
\begin{DoxyCompactList}\small\item\em Вычисление выражения в польской нотации \end{DoxyCompactList}\item 
long double \mbox{\hyperlink{s21__calc_8c_ad3801123e3a90c817398694fde46c911}{calc\+\_\+binary}} (char operation, long double a, long double b)
\begin{DoxyCompactList}\small\item\em Вычисление бинарной операции между 2 числами \end{DoxyCompactList}\item 
long double \mbox{\hyperlink{s21__calc_8c_a988e3d80bf1efc9ba6d5fc84085b7c9e}{calc\+\_\+unary}} (char operation, long double a)
\begin{DoxyCompactList}\small\item\em Вычисление унарной операции между 2 числами \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s21__calc_8c_a8fa97ec5a7233fb4209e962d4756a2ae}{is\+\_\+binary\+\_\+operation}} (char symbol)
\begin{DoxyCompactList}\small\item\em Проверка является ли символ бинарной операцией \end{DoxyCompactList}\item 
int \mbox{\hyperlink{s21__calc_8c_a1d844fdcf4e367747951108a024322f4}{is\+\_\+unary\+\_\+operation}} (char symbol)
\begin{DoxyCompactList}\small\item\em Проверка является ли символ унарной операцией \end{DoxyCompactList}\item 
void \mbox{\hyperlink{s21__calc_8c_a0ebdd47b5d533d3a0e373da59bc08e6d}{calculate\+\_\+credit}} (long double total\+\_\+sum, long double persent, int months, char type, int month\+\_\+number, long double $\ast$monthly\+\_\+payment, long double $\ast$overpayment, long double $\ast$total\+\_\+payment)
\begin{DoxyCompactList}\small\item\em Вычисление параметров кредита \end{DoxyCompactList}\end{DoxyCompactItemize}


\doxysubsection{Функции}
\mbox{\Hypertarget{s21__calc_8c_a6bc0290fd7bb65ace779387602a2f91c}\label{s21__calc_8c_a6bc0290fd7bb65ace779387602a2f91c}} 
\index{s21\_calc.c@{s21\_calc.c}!calc@{calc}}
\index{calc@{calc}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_ad3801123e3a90c817398694fde46c911}\label{s21__calc_8c_ad3801123e3a90c817398694fde46c911}} 
\index{s21\_calc.c@{s21\_calc.c}!calc\_binary@{calc\_binary}}
\index{calc\_binary@{calc\_binary}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a988e3d80bf1efc9ba6d5fc84085b7c9e}\label{s21__calc_8c_a988e3d80bf1efc9ba6d5fc84085b7c9e}} 
\index{s21\_calc.c@{s21\_calc.c}!calc\_unary@{calc\_unary}}
\index{calc\_unary@{calc\_unary}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a0ebdd47b5d533d3a0e373da59bc08e6d}\label{s21__calc_8c_a0ebdd47b5d533d3a0e373da59bc08e6d}} 
\index{s21\_calc.c@{s21\_calc.c}!calculate\_credit@{calculate\_credit}}
\index{calculate\_credit@{calculate\_credit}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_ae346379100c9902e9d21514e33f70279}\label{s21__calc_8c_ae346379100c9902e9d21514e33f70279}} 
\index{s21\_calc.c@{s21\_calc.c}!calculate\_lexems@{calculate\_lexems}}
\index{calculate\_lexems@{calculate\_lexems}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_aa042b6eb8b60790ff8160a48d15f3507}\label{s21__calc_8c_aa042b6eb8b60790ff8160a48d15f3507}} 
\index{s21\_calc.c@{s21\_calc.c}!get\_lexems@{get\_lexems}}
\index{get\_lexems@{get\_lexems}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a6667074b192216c2bf8a45ac5248cfc9}\label{s21__calc_8c_a6667074b192216c2bf8a45ac5248cfc9}} 
\index{s21\_calc.c@{s21\_calc.c}!get\_polish\_notation@{get\_polish\_notation}}
\index{get\_polish\_notation@{get\_polish\_notation}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a8fa97ec5a7233fb4209e962d4756a2ae}\label{s21__calc_8c_a8fa97ec5a7233fb4209e962d4756a2ae}} 
\index{s21\_calc.c@{s21\_calc.c}!is\_binary\_operation@{is\_binary\_operation}}
\index{is\_binary\_operation@{is\_binary\_operation}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_ab3b65ec8106201bd2ffe29d3d3e24d3f}\label{s21__calc_8c_ab3b65ec8106201bd2ffe29d3d3e24d3f}} 
\index{s21\_calc.c@{s21\_calc.c}!is\_digit@{is\_digit}}
\index{is\_digit@{is\_digit}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a1d844fdcf4e367747951108a024322f4}\label{s21__calc_8c_a1d844fdcf4e367747951108a024322f4}} 
\index{s21\_calc.c@{s21\_calc.c}!is\_unary\_operation@{is\_unary\_operation}}
\index{is\_unary\_operation@{is\_unary\_operation}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a1af1a8119589bd1881acf16f56d8bf78}\label{s21__calc_8c_a1af1a8119589bd1881acf16f56d8bf78}} 
\index{s21\_calc.c@{s21\_calc.c}!priority@{priority}}
\index{priority@{priority}!s21\_calc.c@{s21\_calc.c}}
...
\end{DoxyCode}
\mbox{\Hypertarget{s21__calc_8c_a426e7a37f18103788c2ff1fd0b034547}\label{s21__calc_8c_a426e7a37f18103788c2ff1fd0b034547}} 
\index{s21\_calc.c@{s21\_calc.c}!validate\_input@{validate\_input}}
\index{validate\_input@{validate\_input}!s21\_calc.c@{s21\_calc.c}}
